...
abstract class $HistoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String tempPath, bool good, DateTime createdAt});
}
...
class _$HistoryModelImpl implements _HistoryModel {
  ...
  @override
  String toString() {
    return 'HistoryModel(name: $name, tempPath: $tempPath, good: $good, createdAt: $createdAt)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, tempPath, good, createdAt);
...
abstract class _HistoryModel implements HistoryModel {
  const factory _HistoryModel(
      ...
      required final String tempPath,
      required final bool good,
      required final DateTime createdAt}) = _$HistoryModelImpl;
